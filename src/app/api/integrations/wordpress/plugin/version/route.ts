...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    sections: {
      ...
      changelog: '<h4>1.1.5</h4><ul><li>Fix Gutenberg block recovery error caused by inline image styles.</li></ul><h4>1.1.4</h4><ul><li>Fix base64 memory limit exception for very large AI images.</li></ul><h4>1.1.3</h4><ul><li>Added native OTA (Over-The-Air) automatic updates.</li></ul>'
    }
  });
}
