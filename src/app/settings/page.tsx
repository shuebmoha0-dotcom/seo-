...
export default function SettingsPage() {
  ...
  const [websiteUrl, setWebsiteUrl] = useState("https://my-saas-company.com");
  const [repoOwner, setRepoOwner] = useState("acme-corp");
  const [repoName, setRepoName] = useState("marketing-website");
