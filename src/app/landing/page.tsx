  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 selection:bg-indigo-500/20 font-sans antialiased overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-neutral-200/80">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 rounded-xl bg-indigo-600 flex items-center justify-center text-white shadow-sm transition-transform group-hover:scale-105">
              <Sparkles className="w-4 h-4" />
            </div>
            <span className="font-extrabold text-neutral-900 tracking-tight text-lg">SEO Autopilot</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-7 text-xs font-semibold text-neutral-600">
            ...
            <a href="#comparison" className="hover:text-neutral-900 transition-colors">Why Autopilot</a>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold px-4 py-2 rounded-xl transition-all shadow-xs hover:shadow-sm"
            >
              Start Free Trial
            </Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="bg-indigo-600 rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden shadow-xl">
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-white text-xs font-semibold">
              <Sparkles className="w-3.5 h-3.5" /> 14-Day Full Feature Free Trial
            </div>
            ...
            <p className="text-indigo-100 text-sm md:text-base leading-relaxed">
              Connect your domain in under 60 seconds. Review your first technical SEO crawl and keyword opportunities immediately.
            </p>

            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/login"
                className="w-full sm:w-auto bg-white hover:bg-neutral-100 text-indigo-600 font-bold px-8 py-4 rounded-xl text-sm transition-all shadow-md flex items-center justify-center gap-2"
              >
              ...
              <Link
                href="/pricing"
                className="w-full sm:w-auto bg-indigo-700/60 hover:bg-indigo-700 text-white border border-white/20 font-bold px-8 py-4 rounded-xl text-sm transition-colors text-center"
              >
                View Plans &amp; Pricing
              </Link>
            </div>
      ...
      <footer className="border-t border-neutral-200 py-12 px-6 bg-neutral-50 text-neutral-500 text-xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-extrabold text-neutral-900 text-sm">SEO Autopilot</span>
            <span className="text-neutral-400">© {new Date().getFullYear()} SEO Autopilot Inc. All rights reserved.</span>
          </div>
