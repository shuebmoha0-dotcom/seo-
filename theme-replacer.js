...
const files = [
  'c:/Users/Shueb/Desktop/google seo/src/app/opportunities/page.tsx',
  'c:/Users/Shueb/Desktop/google seo/src/app/backlinks/page.tsx',
  'c:/Users/Shueb/Desktop/google seo/src/app/strategy/page.tsx',
  'c:/Users/Shueb/Desktop/google seo/src/app/rank-tracking/page.tsx',
  'c:/Users/Shueb/Desktop/google seo/src/app/site-explorer/page.tsx',
  'c:/Users/Shueb/Desktop/google seo/src/app/technical-seo/page.tsx'
];
...
for (const file of files) {
  if (fs.existsSync(file)) {
    ...
    // We don't want to replace text-white on primary buttons
    // So let's replace text-white only if it's not preceded by something like bg-blue-600
    // A simpler way is to replace text-neutral-100 first
    ...
    // Replace text-white carefully: only if not inside a button class that has bg-indigo/blue/violet
    // Actually, I will replace all text-white to text-neutral-900, then fix specific known buttons
    content = content.replace(/text-white/g, 'text-neutral-900');
    // Fix primary buttons if they were changed
